...
if (f>R)
    ...
    y_2=subs(y_1,[a1,a2,a3],[a(1,1),a(1,2),a(1,3)]); % Substituting the initial joint angles to x equation
    ...
    e=abs(xd-x) %errorl
    I=[1 0 ;0 1];
    H=sqrt(det(J_1*J_1')); % Manipulability 
    h_1=diff(H,a1);    % differentiating H wrt joint angle 'a1' 
    h_2=diff(H,a2);    % differentiating H wrt joint angle 'a1'
    h_3=diff(H,a3);    % differentiating H wrt joint angle 'a1'
    h=[h_1;h_2;h_3]; 
    J_1(3,:)=[h];
    ...
    for w=1:3
        ...
        J_i=inv(J); %Finding the Pseudoinverse of the jacobian
        ad = (J_i)*e; % Change in Joint angles
