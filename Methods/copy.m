...
a=input('Enter the initials angles of the manipulator');
a_d=[0 0 0];
...
while(e(1,1)>0.0001 || e(2,1)>0.0001)   % while error is very less the loop runs
    ...
    %Q_1=subs(Q,[a_t1,a_t2,a_t3],[a(1,1),a(1,2),a(1,3)]); % Passing the values of joint angles into the function after updating
        ...
        H_1=subs(H1,[a1,a2,a3],[a(1,1),a(1,2),a(1,3)]);
  	    ad =(J_i)*e-((I-(J_i*J))*H_1'); % Change in Joint angles
